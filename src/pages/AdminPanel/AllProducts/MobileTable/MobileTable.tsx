...
import { useGetProductsByCategoryQuery, useDeleteProductsMutation, useUpdateMobileMutation } from '../../../../redux/rtk/productsApi';
...
export const MobileTable = () => {
  ...
  const [updateMobile,{error:updateError,isSuccess:isUpdateSuccess}]=useUpdateMobileMutation()
 ...
 console.log(   "showAlert",showAlert);
  ...
  const handleSaveProduct = async(id: string, updatedProduct: RenderedProduct) => {
    ...
    await updateMobile({id:id,mobile:updatedProduct})
    if(isUpdateSuccess){
      console.log('updated');
      setShowAlert(true)
